...
public class YklgloBlock extends ExtraEquipmentModElements.ModElement {
	@ObjectHolder("extra_equipment:yklglo")
	public static final Block block = null;
	@ObjectHolder("extra_equipment:yklglo")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;
	public YklgloBlock(ExtraEquipmentModElements instance) {
		super(instance, 12);
	...
	public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
		event.getRegistry().register(TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("yklglo"));
	}
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.ROCK).sound(SoundType.GROUND).hardnessAndResistance(1f, 10f).lightValue(0));
			setRegistryName("yklglo");
		}
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		public ITextComponent getDefaultName() {
			return new StringTextComponent("yklglo");
		}
